import { verdictLabels, type Investigation, type Locale } from '../src/types.js';
import { evidenceTitle, localize, resultLabel, sourceFailureText, type SourceFailure } from '../src/i18n.js';
